 ...
 * 
 */
package com.ecmdeveloper.plugin.cmis.util;

public class PluginTagNames {

	public static final String CODE_MODULE = "codeModule";
	public static final String OBJECT_STORE_TAG = "objectStore";
	...
	public static final String OBJECT_STORES_TAG = "objectStores";
