 ...
 *
 */
public class DisconnectConnectionTask extends AbstractTask implements IDisconnectConnectionTask {
	...
	public DisconnectConnectionTask(Object connectionName, Map<String,IConnection> connections, IObjectStores objectStores ) {
	...
	public Object call() throws Exception {
		...
		connections.get( connectionName ).disconnect();
