 ...
 * "classdiagram". If a sample multi-page editor (also available
...
public class NewClassDiagramWizard extends Wizard implements INewWizard {
	...
	/**
	 * Constructor for NewClassDiagramWizard.
	 */
	...
	private void throwCoreException(String message) throws CoreException {
		IStatus status =
			new Status(IStatus.ERROR, "com.ecmdeveloper.plugin.diagrams", IStatus.OK, message, null);
