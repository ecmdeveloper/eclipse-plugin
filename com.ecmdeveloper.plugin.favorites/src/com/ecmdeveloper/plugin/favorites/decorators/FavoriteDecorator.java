...
public class FavoriteDecorator implements ILightweightLabelDecorator {
	...
	private static final String FAVORITE_DECORATOR_IMAGE = "icons/bullet_star.png"; //$NON-NLS-1$
	...
	public void decorate(Object element, IDecoration decoration) {
		...
		if ( FavoritesManager.getInstance().isFavorite(objectStoreItem) ) {
			ImageDescriptor descriptor = Activator.getImageDescriptor(FAVORITE_DECORATOR_IMAGE);
