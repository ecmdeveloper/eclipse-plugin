 ...
 *
 */
public class SaveEditorPropertiesHandler extends AbstractHandler {
	...
	private void saveEditorProperties(final IWorkbenchWindow window, Object editorObject) {
		...
		SaveEditorPropertiesJob saveJob = new SaveEditorPropertiesJob((ObjectStoreItemEditor) editorObject, window );
