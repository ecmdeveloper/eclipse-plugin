...
PCK_VERSION=$3
PATH_TO_REPOSITORY="target/repository"
...
do
  ...
  curl -X PUT -T $f -u ${BINTRAY_USER}:${BINTRAY_API_KEY} https://api.bintray.com/content/${BINTRAY_OWNER}/${BINTRAY_REPO}/${PCK_NAME}/${PCK_VERSION}/${PCK_NAME}/${PCK_VERSION}/$f;publish=0
  echo ""
done
...
curl -X PUT -T ../com.ecmdeveloper.plugin.repository-${PCK_VERSION}.zip -u ${BINTRAY_USER}:${BINTRAY_API_KEY} https://api.bintray.com/content/${BINTRAY_OWNER}/${BINTRAY_REPO}/${PCK_NAME}/${PCK_VERSION}/${PCK_NAME}/com.ecmdeveloper.plugin.repository-${PCK_VERSION}.zip;publish=0
echo ""
