 ...
 *
 */
public class CreateClassTestCommand extends CreateCommand {
	...
	public void execute() {
		...
		ClassTestWizard wizard = new ClassTestWizard( child.getQuery() );
		...
		if ( dialog.open() == Dialog.OK ) {
			...
			((ClassTest)child).setClassName( wizard.getClassName() );
			super.execute();
		}
	}	
}
