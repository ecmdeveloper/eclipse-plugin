...
public interface QueryColorConstants {
	...
	public final static Color andContainer = new Color(null, 0, 134, 255);
	public final static Color orContainer = new Color(null, 123, 174, 148);
	public final static Color notContainer = new Color(null, 220, 70, 80);
