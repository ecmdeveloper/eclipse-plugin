 ...
 *
 */
public class SearchResultViewDoubleClickHandler extends AbstractHandler  {
	
	public static final String VIEW_DOCUMENT_COMMAND_ID = "com.ecmdeveloper.plugin.viewThisDocument";
