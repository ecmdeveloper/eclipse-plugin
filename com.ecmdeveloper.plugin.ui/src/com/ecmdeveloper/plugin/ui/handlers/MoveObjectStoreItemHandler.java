...
import com.ecmdeveloper.plugin.ui.jobs.MoveJob;
	...
	class MoveTargetFilter extends ViewerFilter
	{
		...
		public boolean select(Viewer viewer, Object parentElement,
			...
			if ( ( element instanceof IDocument || element instanceof ICustomObject  ) ) {
				return false;
			} else if ( element instanceof IObjectStore ) {
				return objectStore.getId().equalsIgnoreCase( ((IObjectStore) element).getId() );
			}
			return true;
		}
	};
